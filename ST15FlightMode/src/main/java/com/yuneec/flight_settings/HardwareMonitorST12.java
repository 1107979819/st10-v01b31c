...
public class HardwareMonitorST12 extends Activity {
    private static final String TAG = "HardwareMonitor12";
    private TwoSpeedButtonView hm_view_b1;
    private TwoSpeedButtonView hm_view_b2;
    private TwoSpeedButtonView hm_view_b3;
    ...
    private TwoSpeedSwitchView hm_view_s1;
    private ThreeSpeedSwitchView hm_view_s2;
            ...
            if (msg.obj instanceof UARTInfoMessage) {
                ...
                switch (umsg.what) {
                    case 2:
                        ...
                        HardwareMonitorST12.this.setValue(cmsg.channels.size(), cmsg);
                        return;
                    default:
                        return;
                }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.hardware_monitor_main_st12);
        ...
        this.hm_view_b3 = (TwoSpeedButtonView) findViewById(R.id.hm_b3);
        this.hm_view_s1 = (TwoSpeedSwitchView) findViewById(R.id.hm_s1);
        this.hm_view_s2 = (ThreeSpeedSwitchView) findViewById(R.id.hm_s2);
        ...
        this.k3_value = (TextView) findViewById(R.id.k3_value);
        ...
        this.hw_clear.setOnClickListener(new OnClickListener() {
            public void onClick(View v) {
                HardwareMonitorST12.this.j1_value.setTextColor(-4144960);
                HardwareMonitorST12.this.j2_value.setTextColor(-4144960);
                HardwareMonitorST12.this.j3_value.setTextColor(-4144960);
                HardwareMonitorST12.this.j4_value.setTextColor(-4144960);
            }
        });
    }
    ...
    private void setValue(int num, Channel cmsg) {
        ...
        this.hm_view_k3.setValue(knobsDataConversion(((Float) cmsg.channels.get(6)).floatValue()));
        this.k3_value.setText(String.valueOf(slideDataConversion(((Float) cmsg.channels.get(6)).floatValue())));
        this.hm_view_s1.setValue(twoSwitchDataConversion(((Float) cmsg.channels.get(7)).floatValue()));
        this.hm_view_s2.setValue(threeSwitchDataConversion(((Float) cmsg.channels.get(8)).floatValue()));
        this.hm_view_b1.setValue(twoSwitchDataConversion(((Float) cmsg.channels.get(9)).floatValue()));
        this.hm_view_b2.setValue(twoSwitchDataConversion(((Float) cmsg.channels.get(10)).floatValue()));
        this.hm_view_b3.setValue(twoSwitchDataConversion(((Float) cmsg.channels.get(11)).floatValue()));
    }
