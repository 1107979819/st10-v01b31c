...
public class ViewPager extends ViewGroup {
    ...
    void initViewPager() {
        ...
        this.mCloseEnough = (int) (Utilities.K_MAX * density);
            ...
            while (curIndex < this.mItems.size()) {
                ...
                if (ii.position >= this.mCurItem) {
                    ...
                    if (curItem != null) {
                        ...
                        leftWidthNeeded = Utilities.K_MAX - curItem.widthFactor;
                        pos = this.mCurItem - 1;
                        while (pos >= 0) {
                        ...
                        itemIndex = curIndex + 1;
                        if (extraWidthRight < Utilities.K_MAX) {
                            ii = itemIndex >= this.mItems.size() ? (ItemInfo) this.mItems.get(itemIndex) : null;
                            pos = this.mCurItem + 1;
                            while (pos < N) {
                                if (extraWidthRight >= Utilities.K_MAX || pos <= endPos) {
                                    if (ii == null && pos == ii.position) {
        ...
        for (i = 0; i < size; i++) {
            ...
            if (child.getVisibility() != 8) {
                ...
                if (lp != null && lp.isDecor) {
                    ...
                    int widthMode = Utilities.FLAG_HOMEKEY_DISPATCHED;
                    int heightMode = Utilities.FLAG_HOMEKEY_DISPATCHED;
