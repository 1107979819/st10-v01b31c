...
public class PagerTitleStrip extends ViewGroup implements Decor {
    ...
    public PagerTitleStrip(Context context, AttributeSet attrs) {
        ...
        this.mLastKnownPositionOffset = Utilities.B_SWITCH_MIN;
    ...
    void updateText(int currentItem, PagerAdapter adapter) {
        ...
        int childWidthSpec = MeasureSpec.makeMeasureSpec((int) (((float) ((getWidth() - getPaddingLeft()) - getPaddingRight())) * 0.8f), Utilities.FLAG_HOMEKEY_DISPATCHED);
        int childHeightSpec = MeasureSpec.makeMeasureSpec(childHeight, Utilities.FLAG_HOMEKEY_DISPATCHED);
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        childHeight -= padding;
        int childWidthSpec = MeasureSpec.makeMeasureSpec((int) (((float) widthSize) * 0.8f), Utilities.FLAG_HOMEKEY_DISPATCHED);
        int childHeightSpec = MeasureSpec.makeMeasureSpec(childHeight, Utilities.FLAG_HOMEKEY_DISPATCHED);
        this.mPrevText.measure(childWidthSpec, childHeightSpec);
        this.mCurrText.measure(childWidthSpec, childHeightSpec);
        this.mNextText.measure(childWidthSpec, childHeightSpec);
