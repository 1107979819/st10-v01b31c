...
final class FragmentManagerImpl extends FragmentManager {
    static final Interpolator ACCELERATE_CUBIC = new AccelerateInterpolator(Utilities.RIGHT_K_MAX);
    ...
    static final Interpolator DECELERATE_CUBIC = new DecelerateInterpolator(Utilities.RIGHT_K_MAX);
